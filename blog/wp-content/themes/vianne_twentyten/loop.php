...
<?php if ( count( get_the_category() ) ) : ?>
	<li class="cat-links">
		<?php printf( __( '<span class="%1$s">Category: </span> %2$s', 'twentyten' ), 'entry-utility-prep entry-utility-prep-cat-links', get_the_category_list( ', ' ) ); ?><span class="meta-sep">&nbsp;|&nbsp;</span>
	</li>
<?php endif; ?>
...
?>
	<li class="tag-links">
		<?php printf( __( '<span class="%1$s">Tag: </span> %2$s', 'twentyten' ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list ); ?>
	</li>
<?php endif; ?>
...
<?php edit_post_link( __( 'Edit', 'twentyten' ), '<li class="edit-link">', '<span class="meta-sep">&nbsp;|&nbsp;</span></li>' ); ?>
</ul>
